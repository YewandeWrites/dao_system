...
import { idlFactory } from './dao_system.did.js';
export { idlFactory } from './dao_system.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DAO_SYSTEM_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dao_system.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dao_system canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dao_system.did.js")._SERVICE>}
 */
export const dao_system = createActor(canisterId);
